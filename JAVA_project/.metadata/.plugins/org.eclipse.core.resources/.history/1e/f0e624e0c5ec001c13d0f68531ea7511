...
public class GraphFrame extends ApplicationFrame {
    ...
    public GraphFrame(int userIndex) {
        ...
        dataset1.addValue(node_proceed, "현재 진행 상태", "Arduino");
        dataset1.addValue(python_proceed, "현재 진행 상태", "Node.js");
        dataset1.addValue(scratch_proceed, "현재 진행 상태", "Python");
        dataset1.addValue(arduino_proceed, "현재 진행 상태", "Scratch");
