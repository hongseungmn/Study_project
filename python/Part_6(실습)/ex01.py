...
# 사용하면 유저들에게 실행결과를 빠르게 돌려주는 방법

#스택(stack) : 택시기사님의 동전 통, LIFO(Last In First Out)
...
result = []
# _ 기호는 파이썬에서 for 문을 루핑할 때, 변수에 값을 사용하지 않을 때, _로 할당받는 것이다.
